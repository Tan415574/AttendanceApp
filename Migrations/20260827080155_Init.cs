        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingSessions_Meetings_MeetingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MeetingSessionId = table.Column<int>(type: "INTEGER", nullable: false),
                    StudentId = table.Column<string>(type: "TEXT", nullable: false),
                    CheckedInAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Method = table.Column<int>(type: "INTEGER", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ManuallyAdjusted = table.Column<bool>(type: "INTEGER", nullable: false),
                    QueryMessage = table.Column<string>(type: "TEXT", nullable: true),
                    QueryOpen = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_MeetingSessions_MeetingSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_MeetingSessionId_StudentId",
                table: "AttendanceRecords",
                columns: new[] { "MeetingSessionId", "StudentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingSessions_MeetingId",
